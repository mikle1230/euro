...
**输出结构：**
{
  ...
  "days": [{
    ...
    "cityCode": "QUOS 码（见文末表，没有则空）", "countryCode": "国家码（见表，没有则空）",
    "finalCityName": "当晚过夜城市中文名（多城穿行取住宿城市，同城可重复）", "finalCityNameEn": "过夜城市英文名",
    "date": "YYYY-MM-DD（无则空）",
    "items": [{
...
7. 费用人民币估算，仅供参考
8. 城市英文名务必准确（卢塞恩/琉森→Lucerne、米兰→Milan、佛罗伦萨→Florence）；每天必填 finalCityName/finalCityNameEn（过夜城市）；城际 from/to 精确到起终点
9. 只输出 JSON，不要解释文字
10. 景点/酒店英文名：卢浮宫→Louvre、埃菲尔铁塔→Eiffel Tower、凡尔赛宫→Palace of Versailles、圣母院→Notre Dame
11. 城市代码：表内有则直接输出 cityCode/countryCode；表外输出空串，不编造；cityNameEn 仍必填兜底
12. 输出压缩：没内容的字段省略不写（不输出 ""/null）；前端自动补默认值；costCategory 不确定可省

**示例（1 天）：**
{"dayNumber":3,"cityName":"巴黎","cityNameEn":"Paris","cityCode":"PAR","countryCode":"FR","finalCityName":"巴黎","finalCityNameEn":"Paris","items":[
